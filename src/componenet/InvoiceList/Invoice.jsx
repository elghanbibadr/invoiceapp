...
const Invoice = () => {
    return (
        <div className='invoice mt-6  bg-paleBlue p-6 rounded-md cursor-pointer hover:border border-paleCyan '>
            <h3 className='invoice__id text-white font-bold '><strong className='text-paleCyan text-md mr-1'>#</strong>RT2080</h3>
            ...
            <div className='invoice__status  w-fit p-1 flex items-center justify-self-end  '>
                ...
                <span className='text-darkOrange font-bold ml-2 '>Pending</span>
            </div>
